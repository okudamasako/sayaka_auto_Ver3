...
const TIMESLOT_OPTIONS = [
  { value: '7',  label: '7:00',  note: '朝の空気感・静かな前向きさ' },
  { value: '12', label: '12:00', note: '恋愛・距離感・やさしいつながり' },
...
【7:00投稿ルール】
朝の空気感と静かな前向きさを中心に、投稿テーマを3つ提案してください。

重視する要素：
朝の光・深呼吸・小さく整う感覚・静かな始まり・今日を急かさない空気・
軽いリセット・やさしい前向きさ・自分を整える時間・朝の余白感・穏やかなスタート

絶対に寄せないこと：
恋愛・駆け引き・人間関係中心・強い自己啓発・ビジネス論・重い感情・不安を煽る表現

記念日は説明せず、朝の空気感へ自然に変換する。
曜日は絶対に使わない。
...
【12:00投稿ルール】
恋愛・距離感・価値観・人とのつながりを中心に、投稿テーマを3つ提案してください。

重視する要素：
恋愛・距離感・やさしい関係性・気持ちの余白・人とのつながり・
価値観の違いを受け止める感覚・言葉にしすぎない優しさ・自然な共感・穏やかな感情

絶対に寄せないこと：
ビジネス論・キャリア論・強い自己啓発・教訓的な表現・重い恋愛依存表現・ネガティブ共感テンプレ

記念日は説明せず、恋愛・距離感・価値観・人とのつながりへ自然に変換する。
曜日は絶対に使わない。
          ...
          <div className={styles.formGroup}>
            ...
            <p style={{
              ...
              {isProductSlot
                ...
                : timeslot === '7'
                ? '💫 7:00枠：朝の空気感・静かな前向きさテーマへ変換します。'
                : '💫 12:00枠：恋愛・距離感・やさしいつながりテーマへ変換します。'}
            </p>
          </div>
