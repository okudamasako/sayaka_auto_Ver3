...
- **12時（愛のまなざし）**: この時間帯は必ず「恋愛・パートナーとの静かな関係性」を扱います。「ふたり」「隣にいる人」「大切な人」など、特定の相手を感じる表現を投稿文中に必ず含めてください。テーマは「同じ景色を見る」「一緒に笑う」「言葉が少なくても落ち着く」「自然と優しくなれる」など、ふたりの空気感を情景で描くこと。【厳禁】自分磨き・ひとり時間・自己啓発・自分を整える・周囲の人々・一般論。説明せず、情景だけで恋愛の温度感を伝えてください。
...
▼ 禁止方向（12時のみ）
- 感情をまとめる・説明する・教訓として締める文章は書かない。
- 最後を「まとめ」「教訓」「感情説明」で終わらせない。
- 「周囲の人」「みんな」など不特定多数への言及は避ける。
